...
# TODO: Read from a .env file in host directory instead.
...
#     echo "Account information file exists. Reading STORAGE_ACCOUNT_NAME, SUBSCRIPTION_ID and AZ_SUBSCRIPTION_DEFAULT_LOCATION from it."
...
# echo "Creating storage account if it doesn't already exist."
# # TODO: Make the checking more explicit.
# az storage account create --resource-group $RESOURCE_GROUP_NAME --name $STORAGE_ACCOUNT_NAME --sku Standard_LRS --encryption-services blob
...
# echo "az_subscription_default_location = \"$AZ_SUBSCRIPTION_DEFAULT_LOCATION\"" >> terraform.tfvars
# echo "subscription_id = \"$SUBSCRIPTION_ID\"" >> terraform.tfvars
# # TODO: Add the #TOPIC terraform variable.
